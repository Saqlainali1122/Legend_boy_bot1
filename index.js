/**
   * Create By lɛgɛƞ̽d B๏Ɣ
   * Contact Me on 923244180461
*/
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('lɛgɛƞ̽d B๏Ɣ', {
        font: 'Standard',
    ...
    console.log(chalk.green('   lɛgɛƞ̽d B๏Ɣ 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting lɛgɛƞ̽d B๏Ɣ system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅lɛgɛƞ̽d B๏Ɣ bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('lɛgɛƞ̽d B๏Ɣ BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅lɛgɛƞ̽d B๏Ɣ тɛℓɛɢяαм вσт: Active') : chalk.red('❌lɛgɛƞ̽d B๏Ɣ тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ lɛgɛƞ̽d B๏Ɣ system is ready and running!\n'));
    }
