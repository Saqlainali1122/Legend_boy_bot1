...
bot.onText(/\/start/, async (msg) => {
  ...
  await bot.sendPhoto(
    ...
    {
      caption: `🪀 *𝙏𝙝𝙚 ꨄ Lɛgɛƞ̽d b๏Ɣ 𝙏𝙚𝙘𝙝 𝙈𝘿 ꨄ*\n\n╔════════════════════╗\n ⤷ /pair <wa_number>\n ⤷ /unpair <wa_number>\n╚════════════════════╝`,
      parse_mode: 'Markdown',
      reply_markup: {
        inline_keyboard: [
          [{ text: "👑 Owner", url: "https://t.me/ZAKSTORM" }]
        ]
      }
    }
  );
      ...
      `🚨 *You must join our official channels before pairing.*`,
      {
        ...
        reply_markup: {
          inline_keyboard: [
            ...
            [{ text: '📢 Channel 2', url: 'https://t.me/saadkingHelpZone' }],
